...
def _resnet(arch, block, layers, pretrained, progress,num_classes, **kwargs):
    # model = ResNet(block, layers, with_DDP, DDP_layers, num_classes=num_classes,**kwargs)
...
def resnet50(islocal=False, pretrained=False, progress=True, num_classes=1000, **kwargs):
