...
def load_config():
    ...
    parser.add_argument('--wd', default=1e-7, type=float, help='Weight Decay.(default: 1e-4)')
    ...
    parser.add_argument('--max_iter', default=600, type=int, help='Number of iterations.(default: 40)')
    ...
    parser.add_argument('--lr_step', default='420', type=str, help='lr decrease step.(default: 40)')
