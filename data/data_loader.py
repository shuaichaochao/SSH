...
def sample_dataloader(dataloader, num_samples, batch_size, root, dataset, num_works):
    """
    ...
    sample = wrap_data(data, targets, batch_size, root, dataset, num_works)

    return sample, sample_index


def wrap_data(data, targets, batch_size, root, dataset, num_works):
    """
